...
export default function CompetitionDetailsDataReciever({ competitionData, isRegistered }: { competitionData: CompetitionContainerProps, isRegistered: boolean }) {
  ...
  return (
    <>
      ...
      <div className="relative min-h-screen w-screen overflow-hidden flex flex-col justify-center items-center py-4 sm:py-8 gap-4">
        ...
        <div className="relative z-2 flex flex-col gap-4  mb-48 w-[90%] justify-center items-center border-8 border-[#AAF3D5] p-4 md:p-12 rounded-lg shadow-lg backdrop-blur-2xl bg-gradient-to-b from-[#390D62]/40 to-[#6226A4]/40">
          ...
          <div className="w-full overflow-hidden flex flex-col gap-4 backdrop-blur-2xl bg-gradient-to-b from-[#390D62]/40 to-[#6226A4]/40 rounded-lg">
            ...
            <div className="min-h-[400px]">
              ...
              {activeTab === "live" && (
                <LiveScore competitionId={competitionData.id} initialMatches={competitionData.matches!!} />
              )}
            </div>
          </div>
        </div>
