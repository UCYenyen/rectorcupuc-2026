      ...
      >
        ...
        <div className="flex flex-col gap-3">
          <Link
            ...
            className={`flex justify-between items-center p-3 rounded-md border transition-all duration-300 hover:scale-[1.02] ${match.match_status !== "UPCOMMING" && match.team_one_score > match.team_two_score ? "bg-gradient-to-r from-[#6226A4]/60 to-[#FF6BDB] border-white border-3" : "bg-white/10 border-transparent"}`}
          >
          ...
          <Link
            ...
            className={`flex justify-between items-center p-3 rounded-md border transition-all duration-300 hover:scale-[1.02] ${match.match_status === "COMPLETED" && match.team_two_score > match.team_one_score ? "bg-gradient-to-r from-[#E94BFF] to-[#FF6BDB] border-white" : "bg-white/10 border-transparent"}`}
          >
          ...
          <select
            ...
            onChange={(e) =>
              handleStatusChange(
                match.id,
                e.target.value as "ONGOING" | "COMPLETED" | "UPCOMMING",
              )
            }
          ...
          >
            <option value="UPCOMMING" className="bg-[#390D62]">
              UPCOMING
            </option>
            <option value="ONGOING" className="bg-[#390D62]">
              ONGOING
            </option>
            <option value="COMPLETED" className="bg-[#390D62]">
              COMPLETED
            </option>
          </select>
        </div>
