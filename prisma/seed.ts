...
export async function main() {
  ...
  // Sports
    ...
    /*const pingpong =*/ await prisma.competition.create({
        data: { name: "Ping Pong", slug: "ping-pong", location: "TBA", category: CompetitionCategory.Sports, description: "Lorem Ipsum Yenyen", min_team_member:1, max_team_member:2 },
    });
